...
VALUES
  ('Laptop Procurement', 'IT Hardware', CURRENT_DATE + INTERVAL '10 days', 'Need laptops for the operations team.', 'Published', 2),
  ('Office Chair Purchase', 'Office Supplies', CURRENT_DATE + INTERVAL '7 days', 'Ergonomic chairs for new office floor.', 'Approval Pending', 2);
...
VALUES
  (1, 4, 1, 'Pending', NULL),
  (2, 4, 1, 'Approved', 'Good pricing.');

INSERT INTO purchase_orders (rfq_id, quotation_id, po_number, status, created_at)
VALUES
  (2, 2, 'PO-2026-00001', 'Generated', CURRENT_TIMESTAMP);

INSERT INTO invoices (po_id, invoice_number, invoice_date, due_date, status)
VALUES
  (1, 'INV-2026-00001', CURRENT_DATE - INTERVAL '20 days', CURRENT_DATE - INTERVAL '5 days', 'Pending Payment');
